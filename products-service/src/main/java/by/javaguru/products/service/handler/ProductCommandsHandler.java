...
public class ProductCommandsHandler {
    ...
    public void handleCommand(@Payload ReserveProductCommand command) {
        ...
        System.out.println("  ---------------------------------  " + "\n");
        System.out.println(" ReserveProductCommand== handler ");
        System.out.println("  ---------------------------------  " + "\n");

        try {
            Product desireProduct = new Product(command.getProductId(), command.getProductQuantity());
            Product reservedProduct = productService.reserve(desireProduct, command.getProductId());
